    ...
    <div>
        ...
        <div className="char-container">
            ...
            <ContainerMain>
                ...
                <p>Ganha 1 ponto(s) de Sonho Retalhado. Inflige 1 acúmulo(s) de Nó Rubro a um único inimigo-alvo e causa Dano de Raio baixo escalando com o ATQ de Acheron a este alvo, assim como Dano de Raio baixo escalando com o ATQ de Acheron a alvos adjacentes.</p>
                </div>
                ...
                <p>Utiliza sequencialmente Lâmina Pluvial 3 vezes e Ressurreição Estígia 1 vez, causando Dano de Raio massivo, com a escala de ATQ de Acheron a um único inimigo-alvo, e causa Dano de Raio alto, escalando com o ATQ de Acheron a todos os outros inimigos.</p>
                <p>Lâmina Pluvial: Causa Dano de Raio baixo escalando com o ATQ de Acheron a um único inimigo-alvo e remove até 3 acúmulos de Nó Rubro do alvo. 
                Quando o Nó Rubro é removido, imediatamente causa Dano de Raio baixo escalando com o ATQ de Acheron a todos os inimigos. Para cada acúmulo de Nó Rubro removido, o Multiplicador de Dano desta aplicação de Dano é adicionalmente aumentado, até um aumento de 36%.</p>
                <p>Ressurreição Estígia: Causa Dano de Raio médio, escalando com o ATQ de Acheron a todos os inimigos e remove todos os Nós Rubros.
                ...
                [Aprimoramento]
                <p>Quando Sonho Retalhado chega a 9 ponto(s), a Perícia Suprema pode ser utilizada. Durante a Perícia Suprema, reduz a Tenacidade dos inimigos independentemente dos Tipos de Fraquezas e reduz a RES a Todos os Tipos de todos os inimigos minimamente, durando até o final da Perícia Suprema.</p>
                ...
                <p>Imediatamente ataca o inimigo. No início de cada onda, ganha Ascendência Quadrivalente, causando Dano de Raio massivo, escalando com o ATQ de Acheron a todos os inimigos e reduzindo a Tenacidade te todos os inimigos independentemente dos Tipos de Fraqueza. Ao infligir Quebra de Fraqueza, aciona o efeito de Quebra de Fraqueza de Raio.</p>
